...
template<typename T>
MojVector<T>::Iterator MojVector<T>::find(const T &element) const{
    int a=0;
    auto c=begin();
...
//metode
template<typename T>
MojVector<T>& MojVector<T>::push_back(const T& value){
